//! Types and functions to create [`AboutMetadata`] for the
//! [`PredefinedMenuItem::about`](crate::PredefinedMenuItem::about) dialog.
...
/// Creates [`AboutMetadata`] from [Cargo metadata][cargo]. The following fields
/// are set by this function.
///
/// - [`AboutMetadata::name`] (from `CARGO_PKG_NAME`)
/// - [`AboutMetadata::version`] (from `CARGO_PKG_VERSION`)
/// - [`AboutMetadata::short_version`] (from `CARGO_PKG_VERSION_MAJOR` and
